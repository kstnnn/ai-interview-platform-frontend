<template>
  <div class="flex min-h-screen items-center justify-center bg-background px-4 text-center">
    <BaseCard class="max-w-md p-8">
      ...
      <p class="mt-3 text-sm leading-relaxed text-muted-foreground">Your session has ended. Redirecting home.</p>
...
import { resetAppSession } from '@/composables/useAppSession'
