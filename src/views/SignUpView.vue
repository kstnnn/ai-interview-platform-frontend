    ...
    <main class="flex flex-1 items-center px-4 py-12 sm:px-6 lg:px-8">
      <div class="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[0.8fr_1fr] lg:items-center">
        ...
        <section class="order-1 lg:order-2">
          <p class="text-sm font-semibold uppercase tracking-[0.2em] text-primary">Account setup</p>
          <h1 class="mt-4 font-serif text-5xl font-bold tracking-tight text-foreground sm:text-6xl">One account for practice and hiring</h1>
          <p class="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Later your backend can connect this identity to user profiles, organization memberships, business roles, and candidate applications.
          </p>
        </section>
      </div>
    </main>
